...
class CycleCrossover(object):
    ...
    def crossover_rows(self, row1, row2):
        ...
        # Change range to list to allow remove operation
...
class Sudoku(object):
    ...
    def solve(self):
        ...
        for generation in range(0, Ng):
            ...
            # Re-seed the population if 50 generations have passed with the fittest two candidates always having the same fitness.
            if(stale >= 50):
